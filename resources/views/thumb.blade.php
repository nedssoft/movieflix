...
<style>
	.movie_thumb{}
	.btn_opaque{font-size:20px; border: 1px solid #939393;text-decoration: none;margin: 10px;background-color: rgba(0, 0, 0, 0.74); color: #ff0000;}
...
<figure class="effect-sadie col-lg-2 col-md-4 col-sm-6">
	<img src="{{$thumb}}" alt="img02" width="200px" height="200px" />
	<figcaption>
		<p>
